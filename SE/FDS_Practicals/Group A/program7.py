...
A magic square is an n*n matrix of the integers 1 to (n^2) such that the sum of each row, column and diagonals the same.
The figure given below is an example of the magic square for case n=5.
